...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 22 16:15:39 2019

@author: dhruvrajrawat
@Title: Vectorized-Batch Gradient Descent - With Xavier BASED Weight Initialization
"""
...
Theta.append(np.random.uniform(low=-1,high=1)/10)
Theta.append(np.random.uniform(low=-1,high=1)/10)
Theta.append(np.random.uniform(low=-1,high=1)/10)
